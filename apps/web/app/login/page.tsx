    ...
    <div style={{ background: "#0F0F0F", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 400 }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 900, color: "#fff", letterSpacing: -1, marginTop: 8 }}>FlexMatches</h1>
          <p style={{ color: "#888", marginTop: 8 }}>Welcome back</p>
        </div>
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <p style={{ textAlign: "center", color: "#888", fontSize: 14 }}>
            ...
            <Link href="/register" style={{ color: "#FF4500", fontWeight: 600 }}>Sign up</Link>
          </p>
        </form>
      </div>
    </div>
